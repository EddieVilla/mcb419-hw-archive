class Bot {
  ...
  controller() {
    ...
    switch (select("#controller").value()) {
      case 'aggressive':
        // crossed excitation
        this.mtrL = 3 + 80 * this.snsR;
        this.mtrR = 3 + 80 * this.snsL;
        break;
      case 'coward':
        // uncrossed excitation
        this.mtrL = 100 * this.snsL;
        this.mtrR = 100 * this.snsR;
        break;
      case 'explorer':
        // crossed inhibition
        this.mtrL = 4 - 10 * this.snsR;
        this.mtrR = 4 - 10 * this.snsL;
        break;
      case 'love':
        // uncrossed inhibition
        this.mtrL = 4 - 50 * this.snsL;
        this.mtrR = 4 - 50 * this.snsR;
        break;
    }
  }
